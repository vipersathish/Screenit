...
import com.TrueTech.ScreenIT.NewFlow.Pages.RescheduleCandidateProfilePage;
...
public class RescheduleRegressionFlow extends Initializer {
	...
	public void screenitDeclineTest() throws IOException, AWTException, InterruptedException {
		...
		RescheduleCandidateProfilePage.reschedule();

		RescheduleCandidateProfilePage.selectReason(sendkeysprop.getProperty("RESCHEDULEPAGE_SELECTREASON"));

		RescheduleCandidateProfilePage.comment(sendkeysprop.getProperty("RESCHEDULEPAGE_COMMENT"));
		...
		RescheduleCandidateProfilePage.cancel();

		RescheduleCandidateProfilePage.selectReason(sendkeysprop.getProperty("RESCHEDULEPAGE_SELECTREASON"));

		RescheduleCandidateProfilePage.comment(sendkeysprop.getProperty("RESCHEDULEPAGE_COMMENT"));

		RescheduleCandidateProfilePage.clickSubmit();
