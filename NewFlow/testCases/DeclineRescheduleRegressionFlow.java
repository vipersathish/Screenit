...
import com.TrueTech.ScreenIT.NewFlow.Pages.DeclineFlowCandidateProfilePage;
...
public class DeclineRescheduleRegressionFlow extends Initializer {
	...
	public void screenitDeclineTest() throws IOException, AWTException, InterruptedException{
		...
		DeclineFlowCandidateProfilePage.ClickReschedule();
